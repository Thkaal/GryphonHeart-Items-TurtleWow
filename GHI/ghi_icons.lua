...
---  The following data is partly ripped from Ephemeral


GHI_IconCategories = { "Abstract", "Armor", "Consumeable", "Items", "Weapons" }

GHI_IconSubcategories = {
    Abstract = {"Ability", "Enchantment", "Spell", "Trade" },
    Armor = {"Belt", "Boots", "Bracer", "Chestpiece", "Gauntlet", "Helmet", "Cape", "Pants", "Shield", "Shirt", "Shoulder" },
    Consumeable = {"Herb", "Liquid", "Potion", "Solid" },
    Items = {"Container", "Craft", "Gizmo", "Jewelry", "Misc", "Trophy", "Valuable", "Written" },
...
--[[
for _i, _category in pairs( GHI_IconCategories ) do
    _group = {}
    _subcategories = GHI_IconSubcategories[ _category ]
    for _j = 2, table.getn( _subcategories ), 1 do
        _icons = GHI_StockIcons[ _subcategories[ _j ] ]
        for _k = 1, table.getn( _icons ), 1 do
            table.insert( _group, _icons[ _k ] )
        end
    end
    GHI_StockIcons[ _category ] = _group
end ]]
