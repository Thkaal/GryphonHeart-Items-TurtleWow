...
for i=1,meta.total do
	...
	-- A GHI multipart message may have arrived in the inbox header list
	-- before all of its parts are available. Never call GetInboxText()
	-- with a nil inbox index.
	...
	-- The server may know about the message before its body has been
	-- populated locally.
	...
	-- Make sure this really is the expected GHI part.
